package baek2thefuture.domain.webhook.reciever;


import baek2thefuture.domain.comment_bot.GitHubApiCallService;
import baek2thefuture.domain.repository.GitHubRepoEntity;
import baek2thefuture.domain.repository.GitHubRepoEntityRepository;
import baek2thefuture.domain.user.GitHubUserEntity;
import baek2thefuture.domain.user.GitHubUserEntityRepository;
import baek2thefuture.domain.webhook.scripts.ScriptExecutor;
import baek2thefuture.domain.webhook.webhook_models.issue.GitHubIssueDTO;
import baek2thefuture.domain.webhook.webhook_models.issue.GitHubIssueDetail;
import baek2thefuture.domain.webhook.webhook_models.issue.GitHubLabel;
import baek2thefuture.domain.webhook.webhook_models.issue.GitHubUser;
import baek2thefuture.domain.webhook.webhook_models.push.GitHubPushDTO;
import baek2thefuture.domain.webhook.webhook_models.push.GitHubSender;
